...
public class RankManager : MonoBehaviour
{
    ...
    private bool RankUpdated;
    private bool MyRankUpdated;
    ...
    public void PutAndGetRankInfo(int score, int time)
    {
    ...
    private IEnumerator PutAndGetRanking(string token, int score, int time)
    {
        ...
        url = user.host + "/user/v1/games/" + gameName;
